...
/**
 * Upload implementation class Customer
 */
public class CustomerUpload {
	...
	public static String DOCUMENTLIBRARY_PORTLETFOLDER = "Customer";
	...
	public Customer uploadFiles(ActionRequest request,Customer customer) throws PortalException, SystemException, IOException, SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, InvocationTargetException{
			...
			if(strType.equalsIgnoreCase(DOCUMENTFILE)) {
				...
				if(deleteds.get(formField)!=null){
					...
					FileEntry fileEntry = PortletFileRepositoryUtil.addPortletFileEntry(
								groupId, userId, Customer.class.getName(), 
								customer.getPrimaryKey(), portletName, 
	...
	private void callSetMethod(String formField, Customer customer, Long value) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		String strMethod = "set"+StringUtil.upperCaseFirstLetter(formField);
		Method methodSet = customer.getClass().getMethod(strMethod,long.class);
		methodSet.invoke(customer, value);
	}
