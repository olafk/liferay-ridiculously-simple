...
/**
 * Upload implementation class Invoices
 */
public class InvoicesUpload {
	...
	public static String DOCUMENTLIBRARY_PORTLETFOLDER = "Invoices";
	...
	public Invoices uploadFiles(ActionRequest request,Invoices invoices) throws PortalException, SystemException, IOException, SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, InvocationTargetException{
			...
			if(strType.equalsIgnoreCase(DOCUMENTFILE)) {
				...
				if(deleteds.get(formField)!=null){
					...
					FileEntry fileEntry = PortletFileRepositoryUtil.addPortletFileEntry(
								groupId, userId, Invoices.class.getName(), 
								invoices.getPrimaryKey(), portletName, 
	...
	private void callSetMethod(String formField, Invoices invoices, Long value) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException{
		String strMethod = "set"+StringUtil.upperCaseFirstLetter(formField);
		Method methodSet = invoices.getClass().getMethod(strMethod,long.class);
		methodSet.invoke(invoices, value);
	}
